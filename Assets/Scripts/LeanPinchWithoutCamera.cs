...
public class LeanPinchWithoutCamera : MonoBehaviour
{
	...
	[SerializeField] private float zoom = 50.0f;
...
{
	using UnityEditor;
	using TARGET = LeanPinchWithoutCamera;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class LeanPinchWithoutCamera_Editor : CwEditor
	{
