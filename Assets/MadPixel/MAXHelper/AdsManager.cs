...
namespace MAXHelper {
    ...
    public class AdsManager : MonoBehaviour {
        ...
        [SerializeField] private AppLovinComp AppLovin;
        ...
        public void Init()
        {
            ...
            if (!bUseTermsAndATT) InitApplovinInternal();
            else TermsAndATTRoutine();
        ...
        private void Awake()
        {
            ...
            {
                _instance = this;
                Debug.Log("Dont destroy ads");
                GameObject.DontDestroyOnLoad(this.gameObject);

                if (bInitializeOnStart) Init();
            }
            else
            {
                GameObject.Destroy(gameObject);
                Debug.Log($"[Mad Pixel] Two AdsManagers at the same time!");
            }
        }
        ...
        {
            AppLovin.OnInitComplete += AdsInitComplete;
        ...
        private void AdsInitComplete()
        {
            Debug.Log("AdsInitComplete");
            AdsService.Instance.ShowBannerAds();
        }
